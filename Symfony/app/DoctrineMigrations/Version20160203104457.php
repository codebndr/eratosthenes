...
class Version20160203104457 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE LibraryExample (id INT AUTO_INCREMENT NOT NULL, version_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, path VARCHAR(255) NOT NULL, boards VARCHAR(2048) DEFAULT NULL, UNIQUE INDEX version_idx (version_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Architecture_Version (version_id INT NOT NULL, architecture_id INT NOT NULL, INDEX IDX_356FC0C54BBC2705 (version_id), INDEX IDX_356FC0C573F96878 (architecture_id), PRIMARY KEY(version_id, architecture_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE Architecture_Version ADD CONSTRAINT FK_356FC0C54BBC2705 FOREIGN KEY (version_id) REFERENCES Version (id)');
        $this->addSql('ALTER TABLE Architecture_Version ADD CONSTRAINT FK_356FC0C573F96878 FOREIGN KEY (architecture_id) REFERENCES Architecture (id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE Architecture_Version DROP FOREIGN KEY FK_356FC0C573F96878');
        ...
        $this->addSql('ALTER TABLE Architecture_Version DROP FOREIGN KEY FK_356FC0C54BBC2705');
        ...
        $this->addSql('DROP TABLE Architecture_Version');
    }
}
